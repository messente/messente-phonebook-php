...
class BlacklistApi
{
     ...
     *
     * @param  string $phoneNumber A phone number (required)
     *
     * @throws \Messente\Phonebook\ApiException on non-2xx response
     * @throws \InvalidArgumentException
     * @return void
    ...
    {
        $this->isBlacklistedWithHttpInfo($phoneNumber);
    }
     ...
     * @return array of null, HTTP status code, HTTP response headers (array of strings)
     */
    public function isBlacklistedWithHttpInfo($phoneNumber)
    {
        $request = $this->isBlacklistedRequest($phoneNumber);
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function isBlacklistedAsync($phoneNumber)
    {
        return $this->isBlacklistedAsyncWithHttpInfo($phoneNumber)
            ->then(
                function ($response) {
                    return $response[0];
                }
     ...
     * @return \GuzzleHttp\Promise\PromiseInterface
     */
    public function isBlacklistedAsyncWithHttpInfo($phoneNumber)
    {
        $returnType = '';
        $request = $this->isBlacklistedRequest($phoneNumber);
     ...
     * @return \GuzzleHttp\Psr7\Request
     */
    protected function isBlacklistedRequest($phoneNumber)
    {
        // verify the required parameter 'phoneNumber' is set
        if ($phoneNumber === null || (is_array($phoneNumber) && count($phoneNumber) === 0)) {
            throw new \InvalidArgumentException(
                'Missing the required parameter $phoneNumber when calling isBlacklisted'
            );
        }
